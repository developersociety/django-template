...
DATABASES = {
    'default': {
        ...
        'HOST': '2a01:7e00::2:9e09',                            # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
...
MEDIA_ROOT = '%s/htdocs/media/' % SITE_DIR
...
STATIC_ROOT = '%s/htdocs/static/' % SITE_DIR
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    '%s/app/{{ project_name }}/templates' % SITE_DIR,
)
